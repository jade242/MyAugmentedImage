...
import com.example.myaugmentedimage.common.rendering.ShaderUtil;
...
public class ObjectRenderer {
  ...
  public void createOnGlThread(Context context, String objAssetName, String diffuseTextureAssetName)
    ...
    final int fragmentShader =
        ShaderUtil.loadGLShader(TAG, context, GLES20.GL_FRAGMENT_SHADER, "shaders/object_org.frag");
...
//    colorTintParameterUniform = GLES20.glGetUniformLocation(program, "u_ObjColor");
  ...
  public void draw(
    ...
    GLES20.glBindBuffer(GLES20.GL_ELEMENT_ARRAY_BUFFER, indexBufferId);
    Log.d(TAG, "glDrawElements indexCount = "+indexCount);
    Log.d(TAG, "glDrawElements indexBufferId = "+indexBufferId);
