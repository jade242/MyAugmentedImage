 ...
 */
package com.example.myaugmentedimage.augmentedimage.rendering;
...
import com.example.myaugmentedimage.augmentedimage.rendering.ObjectRenderer.BlendMode;
...
public class AugmentedImageRenderer {
  ...
  private final ObjectRenderer imageAndroid = new ObjectRenderer();
  private final ObjectRenderer imageAndroidShadow = new ObjectRenderer();
...
//    imageFrameLowerRight.setBlendMode(BlendMode.SourceAlpha);
    ...
    imageAndroid.createOnGlThread(context, "models/andy.obj","models/andy_new.png");
    imageAndroid.setMaterialProperties(0.0f,2.0f,0.5f,6.0f);
//    imageAndroid.setBlendMode(BlendMode.SourceAlpha);

//    imageAndroidShadow.createOnGlThread(context,"models/andy_shadow.obj","models/andy_shadow.png");
//    imageAndroidShadow.setBlendMode(BlendMode.Shadow);
//    imageAndroidShadow.setMaterialProperties(1.0f,0.0f,0.0f,1.0f);
  }
  ...
  public void draw(
    ...
    float[] objColor = new float[] {70.0f,230.0f,150.0f,255.0f};
    ...
    Pose[] localBoundaryPoses2 = {
      Pose.makeTranslation(
              augmentedImage.getExtentX(),0,augmentedImage.getExtentZ()
      )
    };
...
//    centerAnchor.getPose().compose(localBoundaryPoses2[0]);
    centerAnchor.getPose().toMatrix(modelMatrix,0);
    imageAndroid.updateModelMatrix(modelMatrix,scaleFactor);
//    imageAndroidShadow.updateModelMatrix(modelMatrix,scaleFactor);
    imageAndroid.draw(viewMatrix,projectionMatrix,colorCorrectionRgba,tintColor);
//    imageAndroidShadow.draw(viewMatrix,projectionMatrix,colorCorrectionRgba,tintColor);
  }
  ...
  private static float[] convertHexToColor(int colorHex) {
    ...
    Log.d("tag","color red = "+red+" green = "+ green+" blue");
